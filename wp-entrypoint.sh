...
if ! [ -e index.php -a -e wp-includes/version.php ]; then
  ...
  tar cf - --one-file-system -C /var/www/htdocs/wp . | tar xf -
...
# TODO handle WordPress upgrades magically in the same way, but only if wp-includes/version.php's $wp_version is less than /var/www/htdocs/wp/wp-includes/version.php's $wp_version
